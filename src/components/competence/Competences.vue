  ...
  <div class="competences" id="competences">
    ...
    <div class="line" v-if="langages && sectionStatus">
      ...
      <div class="box h-span">
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/phplang.png" alt="">
        <span>Php</span>
        </div>
         <div class="competence">
    ...
    <div class="line" v-if="outils  && sectionStatus">
      <div class="box h-span">
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/linux.png" alt="">
        <span>Linux</span>
        </div>
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/intellij.png" alt="">
        <span>Intellij</span>
        </div>
      </div>
      ...
      <div class="box h-span">
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/webpack.png" alt="">
        <span>Webpack</span>
        </div>
        <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/gulp.png" alt="">
        <span>Gulp</span>
        </div>
      </div>
      ...
      <div class="box">
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/git.png" alt="">
        <span>Git</span>
        </div>
      </div>
      ...
      <div class="box">
         <div class="competence">
          <img height="80px" width="90px" src="../../assets/competences/tools/docker.png" alt="">
